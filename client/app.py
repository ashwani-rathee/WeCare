...
app.layout = html.Div([
    dbc.Card([
        ...
        html.P('This is the submission for Calhacks which provides a tool to annotate breast tumor which is computer aided(the initial mask comes for radiologists).Automatic segmentation of breast tumors from medical images is important for clinical assessment and treatment planning of breast tumors. '),
        html.P(' ')
    ...
    dbc.Row([
        dbc.Col(html.Button(html.A('Github', href='https://github.com/ashwani-rathee/breast_cancer_awareness', target="_blank"), id='button5', style={'width': '100%'})),
        dbc.Col(html.Button(html.A('Devpost', href='https://devpost.com/software/breast-cancer-tool', target="_blank"), id='button6', style={'width': '100%'})),
        dbc.Col(html.Button(html.A('Linkedin', href='https:/github.com', target="_blank"), id='button7', style={'width': '100%'})),
        dbc.Col(html.Button(html.A('Youtube Vid', href='https://www.youtube.com/watch?v=dQw4w9WgXcQ', target="_blank"), id='button8', style={'width': '100%'})),
    ], className='divfooter'
    ),
